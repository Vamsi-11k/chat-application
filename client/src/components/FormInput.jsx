    ...
    <div className="w-full space-y-1.5">
      ...
      <div className="relative rounded-xl shadow-sm">
        ...
        <input
          ...
          disabled={disabled}
          {...register}
          className={`w-full rounded-xl bg-slate-800/80 border text-slate-100 placeholder-slate-500 text-sm transition-all duration-200 focus:outline-none focus:ring-2 disabled:opacity-50 disabled:cursor-not-allowed ${
            Icon ? 'pl-10' : 'pl-4'
