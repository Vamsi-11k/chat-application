      ...
      <div className="w-full max-w-[420px] bg-white/95 dark:bg-[#061e1a]/95 border border-teal-100/90 dark:border-[#0f3d37]/90 rounded-[32px] p-8 sm:p-10 shadow-2xl shadow-teal-950/15 dark:shadow-black/70 relative overflow-hidden transition-all duration-300 running-border-card">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 relative z-10">
          ...
          <button
            type="submit"
            disabled={isSubmitting}
            className="w-full mt-8 py-3.5 px-4 bg-teal-600 hover:bg-teal-500 active:scale-[0.99] disabled:opacity-50 text-white font-bold rounded-full text-xs uppercase tracking-widest transition-all duration-150 shadow-xl shadow-teal-600/30 flex items-center justify-center space-x-2 running-border-btn"
          >
            {isSubmitting ? (
              <>
                <Spinner size={16} />
