...
export const Landing = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#f2faf5] via-[#e5f5eb] to-[#d8efe0] dark:from-[#03140e] dark:via-[#07241c] dark:to-[#0c382b] text-slate-900 dark:text-slate-100 flex flex-col justify-between selection:bg-emerald-500 selection:text-white transition-colors duration-300 relative overflow-x-hidden p-3 sm:p-6 md:p-8">
      
      {/* Background Soft Deep Bioluminescent Jade & Warm Amber Radial Glows */}
      <div className="fixed inset-0 pointer-events-none -z-10 overflow-hidden">
        {/* Soft jade wash shapes in light mode */}
        <div className="absolute -top-16 -right-16 w-[420px] sm:w-[540px] h-[420px] sm:h-[540px] bg-emerald-200/40 dark:bg-transparent rounded-[60%_40%_30%_70%/60%_30%_70%_40%] blur-2xl transform rotate-12" />
        <div className="absolute -bottom-24 -left-20 w-[380px] sm:w-[480px] h-[380px] sm:h-[480px] bg-amber-200/30 dark:bg-transparent rounded-[40%_60%_70%_30%/40%_40%_60%_60%] blur-3xl transform -rotate-6" />
        
        {/* Dark mode deep obsidian emerald & amber center radial glow */}
        <div className="hidden dark:block absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[720px] h-[720px] bg-radial from-emerald-500/20 via-[#092c22]/40 to-transparent rounded-full blur-3xl" />
        <div className="hidden dark:block absolute -top-20 -left-20 w-96 h-96 bg-amber-500/10 rounded-full blur-3xl" />
        <div className="hidden dark:block absolute -bottom-20 -right-20 w-96 h-96 bg-emerald-600/15 rounded-full blur-3xl" />
      </div>

      {/* ========================================================================= */}
      {/* MAIN FRAMED HERO CONTAINER (Pale Mint Panel in Light / Deep Teal in Dark) */}
      {/* ========================================================================= */}
      <div className="w-full max-w-7xl mx-auto flex-1 flex flex-col rounded-3xl sm:rounded-4xl border border-emerald-200/70 dark:border-[#0f3d37]/90 bg-white/95 dark:bg-[#061e1a]/90 backdrop-blur-2xl shadow-2xl shadow-emerald-950/10 dark:shadow-black/70 relative overflow-hidden transition-all duration-300 running-border-card">
        
        {/* Subtle top inner highlight line */}
        <div className="absolute top-0 inset-x-0 h-px bg-gradient-to-r from-transparent via-emerald-500/40 dark:via-emerald-400/30 to-transparent pointer-events-none" />
        ...
        <header className="w-full px-6 sm:px-10 py-5 flex items-center justify-between border-b border-emerald-100/80 dark:border-[#0d332c]/80 relative z-20">
          ...
          <div className="flex items-center space-x-3 sm:space-x-4">
            <ThemeToggle className="bg-emerald-50/90 dark:bg-[#0b2823]/90 border border-emerald-200/70 dark:border-[#14423a] shadow-xs" />
            
            <Link
              to="/login"
              className="hidden sm:inline-flex px-4 py-2 text-xs font-semibold text-slate-700 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-emerald-400 hover:bg-emerald-100/60 dark:hover:bg-[#0e312b] rounded-full transition-all"
            >
              Sign In
            </Link>
            ...
            <Link
              to="/register"
              className="px-5 py-2.5 text-xs font-semibold text-white bg-emerald-600 hover:bg-emerald-500 active:scale-95 rounded-full shadow-md shadow-emerald-600/30 transition-all duration-150 running-border-btn"
            >
              Get Started
            </Link>
          </div>
        ...
        <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 items-center gap-10 lg:gap-8 px-6 sm:px-10 lg:px-14 py-10 sm:py-14 lg:py-16 relative">
          ...
          <div className="lg:col-span-7 flex flex-col items-start space-y-6 sm:space-y-8 z-10 max-w-2xl">
            ...
            {/* Eyebrow Pill */}
            <div className="inline-flex items-center space-x-2 px-3.5 py-1.5 rounded-full bg-emerald-50 dark:bg-emerald-950/60 border border-emerald-200/90 dark:border-emerald-800/80 text-emerald-800 dark:text-emerald-300 text-xs font-semibold shadow-xs running-border">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold tracking-tight text-slate-900 dark:text-slate-100 leading-[1.12]">
              ...
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-teal-500 to-amber-500 dark:from-[#10e897] dark:via-[#34d399] dark:to-[#fbbf24]">
                Real Time.
              </span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-4 w-full sm:w-auto pt-2">
              <Link
                to="/register"
                className="inline-flex items-center justify-center space-x-2 px-8 py-3.5 bg-emerald-600 hover:bg-emerald-500 active:scale-[0.98] text-white font-semibold rounded-full text-sm shadow-xl shadow-emerald-600/35 transition-all duration-150 running-border-btn"
              >
              ...
              <Link
                to="/login"
                className="inline-flex items-center justify-center px-7 py-3.5 text-sm font-semibold text-slate-700 dark:text-slate-300 hover:text-emerald-600 dark:hover:text-white hover:bg-emerald-50 dark:hover:bg-[#0c2a25] rounded-full border border-emerald-200/80 dark:border-[#14423a] transition-all duration-150"
              >
                Sign In
              </Link>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4 pt-4 sm:pt-6 border-t border-emerald-100 dark:border-[#0f3d37] w-full max-w-lg">
          ...
          >
            ...
            <div className="absolute w-[320px] sm:w-[420px] h-[320px] sm:h-[420px] rounded-full bg-gradient-to-tr from-emerald-500/25 via-teal-600/20 to-amber-500/20 blur-2xl pointer-events-none -z-10" />
            <div className="absolute w-[260px] sm:w-[340px] h-[260px] sm:h-[340px] rounded-full border border-emerald-400/25 dark:border-emerald-500/20 pointer-events-none -z-10 scale-95" />
            <div className="absolute w-[210px] sm:w-[280px] h-[210px] sm:h-[280px] rounded-full bg-gradient-to-br from-emerald-600/20 to-amber-500/15 backdrop-blur-3xl pointer-events-none -z-10" />

            {/* Smartphone Mockup Frame */}
            <div className="relative w-full max-w-[290px] sm:max-w-[320px] rounded-[44px] bg-slate-900 dark:bg-black p-3 shadow-2xl shadow-emerald-950/40 ring-1 ring-slate-800 dark:ring-[#123e37] transition-transform duration-300 hover:scale-[1.02] running-border-card">
